...
public class RoleAuthController extends BaseController{
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "parentRoleGroupId", value = "父级角色组ID", required = true, dataType = "Integer"),
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "roleGroupId", value = "角色组ID", required = true, dataType = "Integer"),
            @ApiImplicitParam(name = "roleName", value = "角色名称", required = true, dataType = "String")
    })
    ...
    @ApiOperation(value="查询角色自定义表列表", notes="查询角色自定义表列表")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "roleId", value = "角色ID", required = true, dataType = "Integer")
    })
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "tableId", value = "自定义表ID", required = true, dataType = "Integer")
    })
    @RequestMapping(value = "/searchCustomArchiveTableFieldList",method = RequestMethod.GET)
    public ResponseResult searchCustomArchiveTableFieldList(HttpServletRequest request, Integer tableId) {
